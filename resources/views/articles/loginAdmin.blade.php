...
@endif
                        <div class="input-group custom">
                            <input type="text" name="email" class="form-control form-control-lg" value="admin@gmail.com" placeholder="Email">
                            <div class="input-group-append custom">
                                <span class="input-group-text"><i class="icon-copy dw dw-user1"></i></span>
                            </div>
                        </div>
                        <div class="input-group custom">
                            <input type="password" name="mdp" class="form-control form-control-lg" value="admin1234" placeholder="**********" required>
                            <div class="input-group-append custom">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="font-16 weight-600 pt-10 pb-10 text-center" data-color="#707373">OU</div>
									<div class="input-group mb-0">
										<a class="btn btn-outline-primary btn-lg btn-block" href="{{url('/')}}">Se connecter en tant qu'auteur</a>
									</div>
                            </div>
