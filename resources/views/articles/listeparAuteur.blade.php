...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo asset('assets/src/plugins/datatables/css/dataTables.bootstrap4.min.css')?>">
    <link rel="stylesheet" type="text/css" href="<?php echo asset('assets/src/plugins/datatables/css/responsive.bootstrap4.min.css')?>">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>{{ $article->statut == 1 ? 'Publié' : 'Non publié' }}</td>

                            <td><a href="{{route('articles.modifierArticle',['id' => $article->id]) }}"> <button  class="btn btn-info btn-lg btn-block">Modifier</button></a></td>
                        </tr>
                        @endforeach
