...
Route::get('/traiterlogAuteur', \App\Http\Controllers\AuteurController::class . '@login');
...
Route::get('/confirmerModifier', \App\Http\Controllers\ArticleController::class . '@confirmerModifier');
Route::get('/logAdmin', \App\Http\Controllers\AdminController::class . '@logAdmin');
Route::get('/traiterlogAdmin', \App\Http\Controllers\AdminController::class . '@login');
